...
async function simpleTest() {
  ...
  const testInput = {
    ...
    merkleRoot:
      "8908493308698473203698033306476070915542398077419263766844709838373568799775", // 正确计算的根值
    nullifier:
      "11804746570097988500406515880312748549061376249652932073901633969830635984160", // poseidon(1)
  };
