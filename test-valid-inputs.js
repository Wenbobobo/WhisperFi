...
async function testValidInputs() {
    ...
    for (let i = 0; i < 3; i++) {  // Just show first 3 levels
        ...
        console.log(`   Level ${i}: hash(${left.toString().substring(0, 10)}..., ${right.toString().substring(0, 10)}...) = ${verifyHash.toString().substring(0, 10)}...`);
    }
    ...
    console.log("   All values are strings:", Object.values(input).every(v => 
