...
task("test-contract-hash", "测试合约的哈希功能")
  .setAction(async (taskArgs, hre) => {
    ...
    try {
      ...
      try {
        ...
        const privacyPool = await PrivacyPool.deploy(await verifier.getAddress(), await hre.ethers.getSigners()[0].getAddress());
      ...
      const testCases = [
        ...
        [8175042333908131853555108599311849679722172756805630201899011284758317870395n, 0n]
      ];
      
      // 获取PoseidonT3合约地址
      const treeAddress = await privacyPool.tree();
      const PoseidonMerkleTree = await hre.ethers.getContractFactory("PoseidonMerkleTree");
