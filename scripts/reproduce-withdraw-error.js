// scripts/reproduce-withdraw-error.js
// 复现withdraw功能中的"Merkle根不匹配"错误
...
async function reproduceWithdrawError() {
  console.log("=== 复现Withdraw Merkle根不匹配错误 ===");
  ...
  console.log("前端计算的Merkle根:", merkleRoot);
...
// 运行测试
reproduceWithdrawError().catch(console.error);